...
public class DefaultJeepOrderDao implements JeepOrderDao {
	  ...
	  @Override
	  public Order saveOrder(Customer customer, Jeep model, Color color, Engine engine, Tire tire, 
			  List<Option> options, BigDecimal price) {
		  SqlParams sqlParams = generateInsertSql(customer, model, color, engine, tire, price);
